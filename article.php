                                 ...
                                 <form action="article.php?id=<?php echo $art['id']; ?>#comment-add-form" class="form" method="post">
                                     ...
                                     if(isset($_POST['do_post']))
                                     {
                                         ...
                                         if(empty($errors))
                                         {
                                             ...
                                             `email`, `text`, `pubdate`, `articles_id`) VALUES ('".$_POST['name']."',
                                             '".$_POST['nickname']."','".$_POST['email']."','".$_POST['text']."',
                                             NOW(),'".$art['id']."')");

                                             echo "<html><head>
                                             <meta http-equiv='Refresh' content='0; URL=article.php?id=$art[id]'>
                                            </head></html>";
                                         }
                                         else
                                         {
                                             //Вывести ошибку
                                             echo '<span style="color: red; font-weight: bold; margin-bottom: 15px;
                                     ...
                                     <div class="form__group">
                                         ...
                                         placeholder="Текст комментария..."><?php echo $_POST['text']; ?>
                                         </textarea>
                                     </div>
                                     <div class="form__group">
